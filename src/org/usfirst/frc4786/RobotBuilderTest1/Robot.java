...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addDefault("Autonomous Command", new AutoLeftSwitch());
   /*     
...
*/
    ...
    public void autonomousInit() {
        ...
        driveTrain.m_drive.setSafetyEnabled(true);
        driveTrain.m_drive.setExpiration(1);
        driveTrain.m_drive.setMaxOutput(1.0);
