...
public class Lifter extends Subsystem {
	...
	private final DoubleSolenoid rampLiftLeft = new DoubleSolenoid(RobotMap.module1, RobotMap.fForwardChannel,
			RobotMap.fReverseChannel);
	private final DoubleSolenoid rampLiftRight = new DoubleSolenoid(RobotMap.module1, RobotMap.gForwardChannel,
			RobotMap.gReverseChannel);

	private final DoubleSolenoid rampRealease = new DoubleSolenoid(RobotMap.module1, RobotMap.eForwardChannel,
			RobotMap.eReverseChannel);
