...
public class DriveTrain extends Subsystem {
    ...
    SpeedControllerGroup m_left = new SpeedControllerGroup(RobotMap.frontLeftTalon, RobotMap.middleLeftTalon, RobotMap.backLeftTalon);
    SpeedControllerGroup m_right = new SpeedControllerGroup(RobotMap.frontRightTalon, RobotMap.middleRightTalon, RobotMap.backRightTalon);
    ...
    public void takeInputValues(double robotSpeed, double turnAmount) {
    	if (!reversed) {
    		...
    		SmartDashboard.putData("Drive Train", m_drive);
    		SmartDashboard.putNumber("Left Side Robot Speed", m_left.get());
    		SmartDashboard.putNumber("Right Side Robot Speed", m_right.get());
    	}
