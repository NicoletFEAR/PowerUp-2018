...
//    private Joystick rightJoystick;
    ...
    private Button xbox1LeftBumper;
    private Button xbox1RightBumper;
    private Button xbox1AButton;
...
//        leftJoystickButton1.whileHeld(new SwitchFront());
         ...
         xbox1LeftBumper = new JoystickButton(xbox1, 5);
         xbox1LeftBumper.whileHeld(new CubeIntakeold());
         
         xbox1RightBumper = new JoystickButton(xbox1, 6);
         xbox1RightBumper.whenPressed(new CubeIntake());
         
         xbox1AButton = new JoystickButton(xbox1, 1);
         xbox1AButton.whenPressed(new CubeMechLift());
    ...
    public Button getXbox1LeftBumper() {
    	return xbox1LeftBumper;
    }
    
    public Button getXbox1RightBumper() {
    	return xbox1RightBumper;
    }
